export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <p className="text-sm text-gray-500">Last updated: September 05, 2025</p>
      <p className="mt-4">
      ...
      <h2 className="mt-8 text-xl font-bold">Interpretation and Definitions</h2>
      ...
      <ul className="list-disc list-inside mt-2 space-y-2">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Don Bosco College, Tc palaya Bengaluru
            560049.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to SWO, accessible from{" "}
            <a
              href="https://swo-liard.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://swo-liard.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <h4 className="mt-2 text-md font-semibold">Personal Data</h4>
      <p>
      ...
      <h4 className="mt-4 text-md font-semibold">Usage Data</h4>
      ...
      <h3 className="mt-4 text-lg font-semibold">Use of Your Personal Data</h3>
      ...
      <h3 className="mt-4 text-lg font-semibold">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="mt-4 text-lg font-semibold">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="mt-4 text-lg font-semibold">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="mt-4 text-lg font-semibold">Disclosure of Your Personal Data</h3>
      <h4 className="mt-2 text-md font-semibold">Business Transactions</h4>
      <p>
      ...
      <h3 className="mt-4 text-lg font-semibold">Security of Your Personal Data</h3>
      <p>
      ...
      {/* Children's Privacy */}
      <h2 className="mt-8 text-xl font-bold">Children&apos;s Privacy</h2>
      <p>
      ...
      <h2 className="mt-8 text-xl font-bold">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="mt-8 text-xl font-bold">Changes to this Privacy Policy</h2>
      <p>
      ...
      <ul className="list-disc list-inside mt-2">
        <li>
          By email:{" "}
          <a
            href="mailto:Admin@dbcblr.edu.in"
